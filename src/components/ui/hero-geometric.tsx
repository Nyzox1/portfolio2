...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0f172a]">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/[0.08] via-transparent to-pink-500/[0.08] blur-3xl" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <Circle className="h-2 w-2 fill-purple-500/80 text-purple-500/80" />
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/50 mb-12 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
                            I craft exceptional digital experiences by combining modern design with technical development. Passionate about innovation and performance.
                        </p>
                    </motion.div>
                    ...
                    >
                        <a
                            href="#projects"
                            className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full text-lg font-medium hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-purple-500/25 transform hover:scale-105"
                        >
                            View my projects
                        </a>
                        <a
                            href="#contact"
                            className="border-2 border-white/20 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-white/10 transition-all duration-300 backdrop-blur-sm transform hover:scale-105"
                        >
                            Contact me
                        </a>
                    </motion.div>
